...
const SITE_URL = "https://safarai.in";
...
export default function ShareButtons({
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="mr-1 flex items-center gap-1 text-xs text-text-muted">
      ...
      {copied && (
        <span className="text-xs text-primary-600 font-medium">Copied!</span>
      )}
    </div>
  );
}
